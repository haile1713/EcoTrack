...
export default function CollectPage() {
	...
	const [hoveredWasteType, setHoveredWasteType] = useState<string | null>(
		null
	);
	...
	const [selectedTask, setSelectedTask] = useState<CollectionTask | null>(
		null
	);
			...
			const imageParts = [
				{
					inlineData: {
						data: base64Data,
						mimeType: "image/jpeg", // can be Adjusted  if the exact type is  known
					},
				},
			];
				...
				<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
					<div className="bg-white rounded-lg p-6 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
						...
						<p className="mb-4 text-sm text-gray-600">
							Upload a photo of the collected waste to verify and earn
							your reward.
						</p>
						<div className="mb-4">
							<label
